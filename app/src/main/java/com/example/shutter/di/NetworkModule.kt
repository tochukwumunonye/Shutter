...
import com.example.shutter.data.remote.api.APIService.Companion.BASE_URL
import com.example.shutter.data.repository.ShutterRepositoryImplementation
...
object NetworkModule {
    ...
    ) = ShutterRepositoryImplementation(
        api = apiService
    ) as ShutterRepository
}
